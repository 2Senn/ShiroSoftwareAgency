...
export const WorkLeft: React.FC<LR> = ({ children, progress }) => {
  let translateY = Math.max(0, 50 - progress * 3 * 50)
  if (progress > 0.05) translateY = Math.max(-50, -(progress - 0.85) * 2 * 50)
  return (
    <div
...
export const WorkRight: React.FC<LR> = ({ children, progress }) => {
