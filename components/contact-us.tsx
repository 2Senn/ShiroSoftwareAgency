...
const ContactUs: React.FC = () => {
  ...
  return (
    <div className="bg-black text-white flex flex-col justify-center  pt-10 min-h-screen">
      <div className="flex-1 flex flex-col justify-center pt-10 items-center lg:pt-6">
        <div className="pb-10">
          <Image src="/assets/logo-icon.png" width={30} height={30} alt="Logo" />
        </div>
        ...
        >
          ...
          {status.submitted ? (
            <div className="text-white text-xl font-bold px-4 py-3 rounded relative" role="alert">Your message has been successfully sent. We will contact you in the near future!</div>
          ) : (
            <>
              <input
                id="companyName"
